    ...
    <div class="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-2 max-w-6xl">
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            ...
            <div class="flex flex-col items-start mt-4">
                ...
                <a class="btn-outline-primary p-3 align-items-center" href="createview.php" role="button">View</a>
            </div>
        </div>
        <!-- Tile 3 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            ...
            <div class="flex flex-col items-start mt-4">
                ...
                <a class="btn-outline-primary p-3 align-items-center" href="selectview.php" role="button">View</a>
            </div>
        </div>
        <!-- Tile 3 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            ...
            <div class="flex flex-col items-start mt-4">
                ...
                <a class="btn-outline-primary p-3 align-items-center" href="updateview.php" role="button">View</a>
            </div>
        </div>
        <!-- Tile 3 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            ...
            <div class="flex flex-col items-start mt-4">
                ...
                <a class="btn-outline-primary p-3 align-items-center" href="deleteview.php" role="button">View</a>
            </div>
        </div>
    </div>
    <!-- Component End  -->
