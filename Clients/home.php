    ...
    <div class="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-2 max-w-6xl">
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            ...
            <div class="flex flex-col items-start mt-4">
                <h4 class="text-xl font-semibold">Lease Details</h4>
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            ...
            <div class="flex flex-col items-start mt-4">
                <h4 class="text-xl font-semibold">Requirements</h4>
                <a class="btn-outline-primary p-3 align-items-center" href="rentproperty.php" role="button">View</a>
            </div>
        </div>
        <!-- Tile 3 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            ...
            <div class="flex flex-col items-start mt-4">
                ...
                <a class="btn-outline-primary p-3 align-items-center" href="view.php" role="button">View</a>
            </div>
        </div>
    </div>
    <!-- Component End  -->
