...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a class="navbar-brand" href="#">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link active" aria-current="page" href="/Sewana/Clients/rentproperty.php">Requirements</a>
...
<h3 class="text-4xl font-normal leading-normal mt-0 mb-2 text-black-800 " align="middle">Your Lease Information</h3>
...
<?php
    ...
    if(isset($_GET['submit'])){
        $search=$_GET['search'];
        $data=$_SESSION['Email'];
        $query1="SELECT lease.Client_number FROM lease, client WHERE client.Email='".$data."'";
        ...
        $query="SELECT * from lease where Client_number='".$search."'";
