...
<h3 class="text-4xl font-normal leading-normal mt-0 mb-2 text-black-800 " align="middle">Update View</h3>
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            <div class="flex flex-col items-start mt-4">
                ...
                ?><br>
                    ...
                    <br>
                    <br><input type="submit" name="submit" value="Update" class="btn-outline-primary p-3 align-items-center"/>
                </form>
                <?php
                if (isset($_POST['submit'])){
                    ...
                    $query="UPDATE views SET View_Date='$date',Comment='$comment'
                    WHERE Property_Number='$Property_Number' AND Client_number='$Client_number'";
                    $result=$conn->query($query);
                    if($result==1){
                                echo '<br>View Updated';
                            }
                            else{
