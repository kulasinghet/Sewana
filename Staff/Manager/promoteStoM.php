...
<h3 class="text-4xl font-normal leading-normal mt-0 mb-2 text-black-800 " align="middle">Promoting a Supervisor to a Manager</h3>
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            <div class="flex flex-col items-start mt-4">
                ...
                <?php 
                    ...
                    $q1 = "SELECT supervisor.Emp_ID from supervisor,staff where Branch_ID='".$branchID."' AND Emp_type='S'";
                    $newslist = "";
                ...
                <?php
                    if (isset($_POST['submit'])){
                        ...
                        $query="INSERT INTO manager (Emp_ID,Appointed_Date,Branch_Id)
                        ...
                        $query1="UPDATE staff SET Emp_type='M' WHERE Emp_ID='".$empID."'";
                        $result1=$conn->query($query1);
                        if($result){
                        ...
                        $conn -> commit();
                        $query2="DELETE FROM supervisor WHERE Emp_ID='".$empID."'";
                        $result2=$conn->query($query2);
                        if($result2){
                                echo '<br>Supervisor table updated';
                            }
                            else{
                                echo '<br>Oops, something went wrong';
                                echo("Error description: " . mysqli_error($conn));
