    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="managerHomepage.php">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link active" aria-current="page" href="/Sewana/Staff/Manager/promoteAtoS.php">Assistant to Supervisor</a>
...
<h3 class="text-4xl font-normal leading-normal mt-0 mb-2 text-black-800 " align="middle">Promoting an Employee to an Assistant</h3>
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            <div class="flex flex-col items-start mt-4">
                ...
                <?php 
                    ...
                    $q1 = "SELECT Emp_ID from staff where Branch_ID='".$branchID."' AND Emp_type='E'";
                    $newslist = "";
                    ...
                    $data=$_SESSION['Email'];
                    $query1="SELECT Supervisor_No FROM supervisor inner join staff where supervisor.Emp_ID=staff.Emp_ID and Branch_ID='".$branchID."'";
                    $result1=$conn->query($query1);
                    echo "<label for='Supervisor_No'>Select Supervisor No: </label>";
                    echo "<select name='Supervisor_No' class='form-control' required>";
                    if($result1){
                        while ($attribute=mysqli_fetch_assoc($result1)){
                            $Supervisor_No=$attribute['Supervisor_No'];
                            echo "<option>".$Supervisor_No."</option>";
                        }
                    }
                    else{
                        echo "&nbsp;&nbsp;&nbsp;&nbsp;Sorry, Not an Available branch Number.";
                ...
                <?php
                    if (isset($_POST['submit'])){
                        ...
                        $Supervisor_No=addslashes($_POST['Supervisor_No']);
                        
                        $query="INSERT INTO assistant (Emp_ID,Supervisor_No)
                        VALUES ('$empID','$Supervisor_No')";
                        ...
                        $query1="UPDATE staff SET Emp_type='AS' WHERE Emp_ID='".$empID."'";
                        $result1=$conn->query($query1);
                        if($result){
