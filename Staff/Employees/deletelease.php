    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="employee.php">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link active" aria-current="page" href="/Sewana/Staff/Employees/selectlease.php">Retrieve</a>
...
<h3 class="text-4xl font-normal leading-normal mt-0 mb-2 text-black-800 " align="middle">Delete Lease</h3>
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            <div class="flex flex-col items-start mt-4">
                ...
                if (isset($_POST['submit'])){
                    $Lease_ID=addslashes($_POST['Lease_ID']);
                    $query="DELETE FROM lease WHERE Lease_ID='$Lease_ID'";
                    $result=$conn->query($query);
                    if($result==1){
                                echo '<br>Lease Deleted';
                            }
                            else{
