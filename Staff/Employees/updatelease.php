...
<h3 class="text-4xl font-normal leading-normal mt-0 mb-2 text-black-800 " align="middle">Update Lease Information</h3>
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            <div class="flex flex-col items-start mt-4">
                ...
                if (isset($_POST['submit'])){
                    ...
                    WHERE Lease_ID='$Lease_ID' AND Client_number='$Client_number'";
                    $result=$conn->query($query);
                    if($result==1){
                                echo '<br>Lease Updated';
                            }
                            else{
