...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
    ...
    <title>Sewana | Create Requirements</title>
...
<div class="flex items-center justify-center w-screen min-h-screen p-10">
    ...
    <div class="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-2 max-w-6xl">
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            ...
            <a class="btn-outline-primary p-3 align-items-center" href="createreq.php" role="button">View</a>
        </div>
        <!-- Tile 2 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            <div class="h-40 bg-gray-400 rounded-lg">
            ...
            <a class="btn-outline-primary p-3 align-items-center" href="selectreq.php" role="button">View</a>
        </div>
        <!-- Tile 3 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            <div class="h-40 bg-gray-400 rounded-lg">
            ...
            <a class="btn-outline-primary p-3 align-items-center" href="updatereq.php" role="button">View</a>
        </div>
        <!-- Tile 4 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            <div class="h-40 bg-gray-400 rounded-lg">
            ...
            <a class="btn-outline-primary p-3 align-items-center" href="deletereq.php" role="button">View</a>
        </div>
    </div>
    <!-- Component End  -->
