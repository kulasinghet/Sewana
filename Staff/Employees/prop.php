...
<h3 class="text-4xl font-normal leading-normal mt-0 mb-2 text-black-800 " align="middle">Properties</h3>
...
<div class="flex items-center justify-center w-screen min-h-screen p-10">
    ...
    <div class="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-2 max-w-6xl">
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            ...
            <a class="btn-outline-primary p-3 align-items-center" href="createprop.php" role="button">View</a>
        </div>
        <!-- Tile 1 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            <div class="h-40 bg-gray-400 rounded-lg">
            ...
            <a class="btn-outline-primary p-3 align-items-center" href="selectprop.php" role="button">View</a>
        </div>
        <!-- Tile 2 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            <div class="h-40 bg-gray-400 rounded-lg">
            ...
            <a class="btn-outline-primary p-3 align-items-center" href="updateprop.php" role="button">View</a>
        </div>
        <!-- Tile 3 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            <div class="h-40 bg-gray-400 rounded-lg">
            ...
            <a class="btn-outline-primary p-3 align-items-center" href="deleteprop.php" role="button">View</a>
        </div>
    </div>
    <!-- Component End  -->
