    ...
    <div class="grid-cols-1 gap-2 max-w-6xl">
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            <div class="flex flex-col items-start mt-4">
                ...
                ?><br>
                    <input type="text" name="rent" class="form-control" placeholder="Enter Proposed Rental"/>
                ...
                if (isset($_POST['submit'])){
                    ...
                    if(!$rent){
                        $query="UPDATE property SET Availability='$avail'
                        WHERE Property_number='$Property_number'";
                    }
                    else{
                        $query="UPDATE property SET Proposed_rental='$rent',Availability='$avail'
                        WHERE Property_number='$Property_number'";
                    }
