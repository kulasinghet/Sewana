    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="employee.php">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link active" aria-current="page" href="/Sewana/Staff/Employees/selectad.php">Retreive</a>
    ...
    <div class="grid xl:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2 max-w-6xl">
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            ...
            <div class="flex flex-col items-start mt-4">
                <h4 class="text-xl font-semibold">Create Advertisement</h4>
            </div>
            <a class="btn-outline-primary p-3 align-items-center" href="createad.php" role="button">View</a>
        </div>
        <!-- Tile 2 -->
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2" style="place-items:center;">
            <div class="h-40 bg-gray-400 rounded-lg">
            ...
            <div class="flex flex-col items-start mt-4">
                <h4 class="text-xl font-semibold">Add Newspaper</h4>
            </div>
            <a class="btn-outline-primary p-3 align-items-center" href="createnews.php" role="button">View</a>
        </div>
    </div>
    <!-- Component End  -->
