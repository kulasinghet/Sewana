...
<head>
    ...
    <title>Sewana | Login Manager</title>
    <style>
        .text-4xl{
            padding-top: 10vh;
        }
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            <div class="flex flex-col items-start mt-4">
                ...
                if(isset($_POST['submit'])){
                    ...
                    $query="SELECT * FROM userlogin natural join staff WHERE staff.Emp_type='M' AND userlogin.Email='".addslashes($email)."' AND userlogin.password='".addslashes($password)."'";
