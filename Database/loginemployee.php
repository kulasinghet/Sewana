...
<head>
    ...
    <title>Sewana | Login Employee</title>
    <style>
        .text-4xl{
            padding-top: 10vh;
        }
        ...
        <div class="flex flex-col bg-gray-200 rounded-lg p-4 m-2">
            <div class="flex flex-col items-start mt-4">
                ...
                if(isset($_POST['submit'])){
                    ...
                    $query="SELECT * FROM userlogin natural join client WHERE userlogin.Email='".addslashes($email)."' AND password='".addslashes($password)."'";
                    ...
                    if (!empty($result) && $result->num_rows > 0){
                        ...
                        $_SESSION['type']="employee";
                                ...
                                echo 'window.location.href="/Sewana/Clients/home.php";';
                                echo '</script>';
                        exit;
                    }else{
